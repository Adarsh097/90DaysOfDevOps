...
- How Vault protected Docker Hub credentials
   - I used Ansible Vault to encrypt Docker Hub credentials (username and password).
   - These are stored securely and decrypted at runtime, so sensitive data is not exposed in plain text.”
